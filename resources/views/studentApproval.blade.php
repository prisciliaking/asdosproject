...
<body>
    ...
    <main class="p-6">
        <h2 class="text-2xl font-bold mb-4">Accepted Courses for {{ $user->user_name }}</h2>
            ...
            <table class="min-w-full table-auto border-collapse">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                                <a href="{{ $course->mataKuliah->whats_app_link }}" target="_blank" class="text-blue-500 underline">
                                    Join Group
                                </a>
                        </td>
                    </tr>
